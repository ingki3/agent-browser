...
**실환경 태스크 완수율** — 공개 사이트 12곳, 난이도 6단계, 31개 태스크를 실제 LLM으로 수행합니다. 최근 측정은 샌드박스 25개 25/25, 상용 사이트 6개 6/6입니다(별도 실행). 성공 판정은 에이전트의 자기 보고가 아니라 최종 페이지 상태를 JavaScript로 독립 검증합니다.
...
482개가 통과해야 합니다. Chromium이 필요한 테스트가 포함되어 있습니다.
